...
2026-09-21 的同机候选验收使用 Host digest `69afd97e…07b09` 与 Core package digest `fdf4ab7d…df2738`。Creator 3.8.3 与 3.8.7 均完成 30 分钟正常负载、10 分钟过载和 retention 冷却：每版成功读取 38,560 次、成功写入 18,248 次、完成批次 1,912 个，记录 183 次有界拒绝和 61 次成功退避重试，业务失败为 0；control P95 分别为 3.074 ms 与 2.928 ms。100 资源三轮聚合批次相对逐项执行分别达到 2.139 倍与 2.010 倍，冷却后任务与探针残留均为 0，`project.log` 无新增 error/warn。外部归档报告摘要分别为 `1ccd0346793fd8b24a17c1f30e5ce86bf8e79724bb9f89ed6ea103fea2e52813` 与 `6428f27c5b202853512d9529205314676c37b0b1a66d96457e227009ca37732e`。
